...
def var_temp_plot_avg(config, start_temp, end_temp, temp_step_nr, iterations_per_temp,
    ...
    if energy_plot:
        ...
        if save:
            if plot_name is None:
                plt.savefig(f'varplotavg_energy_length{protein.length}_iterations{iterations_per_temp}_start{start_temp}_end{end_temp}.pdf')
            else:
                plt.savefig(plot_name)
    ...
    if length_plot:
        ...
        if save:
            if plot_name is None:
                plt.savefig(f'varplotavg_length_length{protein.length}_iterations{iterations_per_temp}_start{start_temp}_end{end_temp}.pdf')
            else:
                plt.savefig(plot_name)
